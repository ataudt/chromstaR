...
bivalent.BN <- segments[segments$BN == '[H3K27me3+H3K4me3]' &
                        segments$SHR != '[H3K27me3+H3K4me3]']
## Obtain all genomic regions where BN and SHR have promoters
...
# We expect promoter [H3K4me3] and bivalent-promoter signatures [H3K4me3+H3K27me3]
# to be enriched at transcription start sites.
plots <- plotEnrichment(hmm = model, annotation = genes, bp.around.annotation = 15000)
...
\item Run \Rfunction{Chromstar} with mode='mark' or mode='condition' and see if the results improve.
