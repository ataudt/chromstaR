...
<<multivariate_combinatorial_analysis, results='markup', message=FALSE, eval=TRUE>>=
...
<<multivariate_combinatorial_analysis_plot1, results='markup', message=FALSE, eval=TRUE, fig.width=6, fig.height=4>>=
...
@
<<multivariate_combinatorial_analysis_plot2, results='markup', message=FALSE, eval=TRUE, fig.width=8, fig.height=4>>=
